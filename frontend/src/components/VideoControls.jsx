...
const VideoControls = ({ isPlaying, onTogglePlay, currentTime, duration, volume = 1, onVolumeChange, onFullscreen, loop, onToggleLoop, playbackRate, onPlaybackRateChange, onToggleComments, isCompareMode, compareAudioEnabled, onToggleCompareAudio, onStepFrame }) => {
  ...
  return (
    <div className="h-16 md:h-12 bg-card border-t border-border flex items-center justify-between px-2 md:px-4 select-none">
      <div className="flex items-center gap-1 md:gap-4">
        ...
        <span className="text-xs md:text-sm font-mono text-muted-foreground ml-1 hidden sm:inline-block">
