            ...
            {breadcrumbs.map((item, index) => {
              ...
              return (
                <Fragment key={index}>
                  ...
                  {linkTarget ? (
                    <Link to={linkTarget} className="text-muted-foreground hover:text-foreground transition-colors truncate max-w-[100px] sm:max-w-[150px] block">
                      {item}
                    </Link>
                  ) : (
                    <span className={`${isLast ? "text-foreground font-semibold" : "text-muted-foreground"} truncate max-w-[120px] sm:max-w-[200px] block`}>
                      {item}
                    </span>
                  )}
                </Fragment>
