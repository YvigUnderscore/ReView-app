         ...
         <section className="py-24 text-center px-6">
            ...
            >
               ...
               <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <a href="https://discord.gg/RFsD7hmPRq" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-8 py-3 bg-zinc-800 text-white font-medium rounded-lg hover:bg-zinc-700 transition-all hover:scale-105">
                     Join Discord
                  </a>
               </div>
            </motion.div>
